      ...
      { orders!=null && orders.length &&  orders.map((order)=>(
          ...
          <div className="flex min-w-0 gap-x-4 ">
            <div className="min-w-0 flex-auto">
              <p className="text-sm font-semibold leading-6 text-gray-900">{order.selectedAddress[0].name}</p>
              <p className="mt-1 truncate text-xs leading-5 text-gray-500">{order.selectedAddress[0].street}</p>
              <p className="mt-1 truncate text-xs leading-5 text-gray-500">{order.selectedAddress[0].pinCode}</p>
            </div>
            
           
          </div>
          <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
            <p className="text-sm leading-6 text-gray-900">{order.selectedAddress[0].phone}</p>
            <p className="text-sm leading-6 text-gray-900">{order.selectedAddress[0].city}</p>
            </div>
