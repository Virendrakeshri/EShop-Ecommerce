...
import { fetchAllProductsAsync, fetchBrandsAsync, fetchCategoriesAsync, fetchProductsByFiltersAsync, selectbrands, selectcategories} from "../productListSlice";
...
export default function ProductList() {
  ...
  const handleFilter=(e,section,option)=>{
    // will support multiple filter on server;
  ...
  return (
    ...
    <div className="bg-white">
      <div>
       ...
       <Pagination handlePage={handlePage} page={page} setPage={setPage} totalItems={totalItems} filters={filters}></Pagination>
    </div>
        </main>
      </div>
    </div>
                      ...
                      <>
                        ...
                        <Disclosure.Panel className="pt-6">
                          <div className="space-y-4">
                            { section.options!=undefined  && section.options.map((option, optionIdx) => (
              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                  ...
                  <form className="mt-4 border-t border-gray-200">
                    ...
                    { filters!=undefined && filters.length>0 && filters.map((section) => (
...
function Pagination({handlePage,page,setPage,totalItems,filters}){
  totalItems=100;
 ...
 function Pgination({handlePage,page,setPage,totalItems,filters}) {
  console.log(totalItems);
  const totalPages=Math.ceil(totalItems/ITEMS_PER_PAGE);
  return (
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
